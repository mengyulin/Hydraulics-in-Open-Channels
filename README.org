...
Google [[https://colab.research.google.com/?hl=zh-tw][Colab]] 可以讓使用者在 Google 的雲端編輯並執行 Python 程式與 Jupyter Notebook 環境。使用者需要有 Google (或 Gmail) 帳戶。
...
過程請參見課程講義。
- Python 程式碼 (使用 Colab): [[https://colab.research.google.com/github/mengyulin/Hydraulics-in-Open-Channels/blob/main/Chap_5/Exe1_DirectStepMethod.ipynb][https://colab.research.google.com/assets/colab-badge.svg]]
- Python 程式碼: [[./Chap_5/Exe1_DirectStepMethod.ipynb][Exe1_DirectStepMethod.ipynb]]
- Python 程式碼 (pdf 格式): [[./Chap_5/Exe1_DirectStepMethod.pdf][Exe1_DirectStepMethod.pdf]]

**** Excel 試算表

- 見: [[./Chap_5/Ex1_DirectMethodExam.xlsx][Ex1_DirectMethodExam.xlsx]]
...
- Python 程式碼 (使用 Colab): [[https://colab.research.google.com/github/mengyulin/Hydraulics-in-Open-Channels/blob/main/Chap_5/DirectInt.ipynb][https://colab.research.google.com/assets/colab-badge.svg]]

** Standard Step Method
*** 講義例題 1

- Python 程式碼 (使用 Colab): [[https://colab.research.google.com/github/mengyulin/Hydraulics-in-Open-Channels/blob/main/Chap_5/StdStepMethod.ipynb][https://colab.research.google.com/assets/colab-badge.svg]]


*** 範例：緩坡具閘門之渠道

- Python 程式碼 (使用 Colab):  [[https://colab.research.google.com/github/mengyulin/Hydraulics-in-Open-Channels/blob/main/Chap_5/GVF_gate_demo.ipynb][https://colab.research.google.com/assets/colab-badge.svg]]
